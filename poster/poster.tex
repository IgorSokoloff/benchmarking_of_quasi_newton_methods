...
\begin{flushleft}
	\begin{tabular}{ p{18cm}|p{5cm}|p{7cm}}
		...
		%\hline
		{proportion of problems where have been successfully found global minimizer in more than half of all launches}& { in more than 0.99 launches} &square under perforanse profile plot
				\end{tabular}
		\end{flushleft}
...
\begin{itemize}
	\item Though SR1 is the least robustness it found 
\end{itemize}
Source code of this work is available here
%\medskip
%\hrule\medskip
